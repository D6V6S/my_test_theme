 ...
 * @see WP_Widget
 */
class Mytheme_Widget_Sibscibe extends WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			'classname'                   => 'widget_subscribe news_sletter side_bar_sub_heading',
		...
		parent::__construct('mytheme-subscribe-form', __('Subscribe form'), $widget_ops, $control_ops);
	}
